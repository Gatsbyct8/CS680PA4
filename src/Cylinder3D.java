...
public class Cylinder3D
{
	...
	public Cylinder3D(float _x, float _y, float _z, float _rx, float _ry, float zMin, float zMax, int _stacks, int _slices)
	{
	...
	private void fillMesh()
	{
		...
		for (i = 0, theta = -pi; i < stacks; ++i, theta += dtheta){
			...
			//rear endcap
			//mesh.n[i][0] = new Point3D(cos_theta,sin_theta,0);
			...
			//front endcap
			//mesh.n[i][slices-1] = new Point3D(cos_theta,sin_theta,0);
